CREATE TABLE  "DEMOTFA_USERS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"SHARED_SECRET" VARCHAR2(16) COLLATE "USING_NLS_COMP", 
	 CONSTRAINT "DEMOTFA_USERS_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "DEMOTFA_USERS_UK1" UNIQUE ("USERNAME")
  USING INDEX  ENABLE
   )  DEFAULT COLLATION "USING_NLS_COMP"
/
create or replace package DEMOTFA_AUTH as
function get_hash (
...
/
create or replace package body DEMOTFA_AUTH as
  function get_hash (
    p_username in varchar2
  , p_password in varchar2 )
    return varchar2
  ...
  begin
    ...
    if demotfa_auth.authenticate (p_username=>p_username
  ...
  as
    l_shared_secret demotfa_users.shared_secret%type;
  begin
